...
> "Alguns filósofos são preparados para desacreditar a noção da vontade do homem como sendo uma ilusão e um auto"-engano, porque o homem deve involuntariamente se comportar de acordo com as inevitáveis leis da causalidade. Eles podem estar certos ou errados do ponto de vista da causa primeira ou da causa de si.\nota{N. do T.: causa primeira = primus movens e causa de si = causa sui.} No entanto, do ponto de vista humano, a ação é o fato fundamental. Nós não afirmamos que o homem é "livre"{} para escolher e agir. Nós meramente estabelecemos o fato de que ele escolhe e age."{}[^22]
