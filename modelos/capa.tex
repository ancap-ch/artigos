\noindent\begin{tikzpicture}[remember picture]
  ...
  \ifdefined\titulo 
    ...
    ,opacity=0
      ...
      \ifdefined\mobile
     	\begin{varwidth}{.925\textwidth}\LARGE{\textsc{\titulo}}\end{varwidth}
      \else
  ...
  \ifdefined\autor
    ...
    ,opacity=0
      ...
      \ifdefined\mobile
     	\begin{varwidth}{.925\textwidth}\large{\textsc{\autor}}\end{varwidth}};
      \else
  ...
  \ifdefined\tradutor
    ...
    ,opacity=0
      ...
      \ifdefined\mobile
     	\begin{varwidth}{.925\textwidth}{Tradução: \textsc{\tradutor}}\end{varwidth}};
      \else
